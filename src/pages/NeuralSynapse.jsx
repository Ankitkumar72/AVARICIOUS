            ...
            <div className="app-layout" style={{ minHeight: '100vh', border: 'none', position: 'relative' }}>
                ...
                <div className="neural-grid-container" style={{ position: 'relative', height: 'calc(100vh - 60px)', width: '100%', overflow: 'hidden' }}>
                    ...
                    <svg style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', pointerEvents: 'none', zIndex: 0 }}>
                        {/* Center to Top-Right */}
                        <line x1="50%" y1="50%" x2="75%" y2="25%" stroke="rgba(255,255,255,0.1)" strokeDasharray="4" />
                        {/* Center to Left Panel */}
                        <line x1="50%" y1="50%" x2="25%" y2="30%" stroke="rgba(255,255,255,0.1)" strokeDasharray="4" />
                        {/* Center to Bottom Right */}
                        <line x1="50%" y1="50%" x2="70%" y2="70%" stroke="rgba(255,255,255,0.1)" strokeDasharray="4" />
                    </svg>

                    {/* Central Mesh */}
                    <div className="center-mesh" style={{
                    ...
                    <div style={{ position: 'absolute', top: '15%', left: '40%', border: '1px solid #333', padding: '15px 30px', background: 'rgba(0,0,0,0.8)' }}>
                        <div className="mono" style={{ fontSize: '0.7rem', color: '#fff' }}>NODE_ALPHA</div>
                    </div>

                    {/* Left Panel: Neural Interface */}
                    <div style={{ position: 'absolute', top: '25%', left: '5%', width: '250px', zIndex: 2 }}>
                        ...
                        <div style={{ marginTop: '100px', fontSize: '0.6rem', color: '#444', lineHeight: '1.6' }} className="mono">
                    ...
                    {/* Top Right Node */}
                    <div style={{ position: 'absolute', top: '25%', right: '20%', width: '80px', height: '80px', border: '1px solid #444', borderRadius: '50%', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <div style={{ position: 'absolute', bottom: '20%', right: '5%', width: '300px', borderLeft: '1px solid #333', paddingLeft: '20px' }}>
                    ...
                    <div style={{ position: 'absolute', top: '40%', right: '15%', border: '1px solid #333', padding: '10px 30px' }}>
                        <div className="mono" style={{ fontSize: '0.7rem', color: '#aaa' }}>SIGNAL_MOD</div>
                    </div>

                    {/* Footer Info */}
                    <div className="mono" style={{ position: 'absolute', bottom: '20px', left: '20px', fontSize: '0.6rem', color: '#444' }}>
                        © PIXY_NEWS_ARCH_GRID_2024
                    </div>
                    <div className="mono" style={{ position: 'absolute', bottom: '20px', right: '20px', fontSize: '0.6rem', color: '#444' }}>
