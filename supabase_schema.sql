...
BEGIN 
  ...
  IF NOT EXISTS (
    ...
    ALTER TABLE public.news_posts ADD COLUMN created_at TIMESTAMP WITH TIME ZONE DEFAULT timezone('utc'::text, now()) NOT NULL;
  END IF;
  ...
  IF NOT EXISTS (
    ...
    ALTER TABLE public.news_posts ADD COLUMN updated_at TIMESTAMP WITH TIME ZONE DEFAULT timezone('utc'::text, now()) NOT NULL;
  END IF;
END $$;
